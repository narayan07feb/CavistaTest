package com.cavistatest.adapter
...
import com.cavistatest.R
import com.cavistatest.`interface`.ItemCallback
import com.cavistatest.ext.getImageUrl
import com.cavistatest.model.AppBean
import com.cavistatest.model.Data
import com.cavistatest.model.ErrorPageModel
import com.cavistatest.model.PagerProgressModel
import java.util.*
...
class SearchAdapter(
    ...
    inner class ProgressViewLoader(@param:NonNull val mView: View) :
        RecyclerView.ViewHolder(mView) {
